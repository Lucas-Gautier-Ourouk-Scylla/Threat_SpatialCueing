...
p_load(tinytex, knitr, kableExtra, readr, dplyr, tidyverse, psych, Hmisc, mada, party, pdp, psych, lmerTest, mice, VIM, missForest, lavaan, semPlot, lattice, sjPlot, broom.mixed, buildmer, performance, insight, MVN, ggplot2)
...
Here, we remove trials reflecting outliers in terms of Studentized residuals, hat values and cook distance. For that we removed rows with : 
    - Studentized residuals > 3 or Studentized residuals < -3
    - Hat values > .020 (its a relative threshold based on histogram and visual inspection of these values)
    - Cook distance > .020 (its a relative threshold based on histogram and visual inspection of these values)
...
## Old analysis and results reporting

The second effet is more interesting and show that the more participants feel threatened by screams the faster they respond on the categorisation task. Here is a graphic representation of this effect: 

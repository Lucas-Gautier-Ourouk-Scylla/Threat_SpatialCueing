...
values \> .071 (its a relative threshold based on histogram and visual
inspection of these values) - Cook distance \> .050 (its a relative
...
Some of analysis reportings have to be checked because we based these results on categorization results



## Old analysis

An effet show that the more participants
...
An additional analysis, revealed a significant interaction
...
and who judge it as not threatening, higher self-reported anxiety is associated to slower RT whereas for participants that feel highly preoccupied by the screams and who judge it as not threatening, higher self-reported anxiety is associated to faster RT. 
Here is a graph of this interaction:
